...
func TestDashboardSuccessExcludesErroredTwoHundredResponses(t *testing.T) {
	...
	_, err = db.Exec(`CREATE TABLE request_log (
		...
		cache_read_tokens INTEGER DEFAULT 0, total_cost REAL DEFAULT 0,
		input_cost REAL DEFAULT 0, output_cost REAL DEFAULT 0,
		cache_create_cost REAL DEFAULT 0, cache_read_cost REAL DEFAULT 0,
